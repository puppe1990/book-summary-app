  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl max-h-[90vh] bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row z-10 font-sans border border-slate-100"
        id="sub-modal-container"
      >
        <button 
          onClick={onClose}
          className="absolute right-4 top-4 text-slate-400 hover:text-slate-600 transition-colors z-20 p-1 hover:bg-slate-50 rounded-full"
          id="btn-close-sub"
        ...
        <div className="md:w-1/2 bg-white p-8 flex flex-col justify-center relative">
          <AnimatePresence mode="wait">
            {!success ? (
              ...
              >
                <div>
                  <h3 className="text-xl font-bold text-slate-900 mb-2">Detalhes do Plano</h3>
                  
                  {/* Period selection slider or toggle */}
                  <div className="bg-slate-100 p-1.5 rounded-xl flex items-center justify-between mb-6">
                    <button
                      type="button"
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 text-xs font-semibold rounded-lg relative transition-all ${
                        billingCycle === 'annual'
                          ? 'bg-white text-slate-900 shadow-sm'
                          : 'text-slate-500 hover:text-slate-800'
                      }`}
                    ...
                    >
                      Anual
                      <span className="absolute -top-1.5 -right-1 bg-red-100 text-red-600 text-[9px] font-bold px-1.5 py-0.2 rounded-full border border-red-200 tracking-tight">
                        -30%
                      </span>
                    </button>
                  </div>
                  ...
                  <div className="flex justify-between items-baseline mb-6 pb-4 border-b border-slate-100">
                    <span className="text-slate-500 text-sm">Preço da Assinatura:</span>
                    <div className="text-right">
                      ...
                      <span className="text-slate-500 text-xs">/mês{billingCycle === 'annual' ? ' (cobrado anualmente)' : ''}</span>
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 bg-slate-50 border rounded-lg text-slate-800 text-sm focus:outline-none focus:ring-2 placeholder:text-slate-400 transition-all ${
                          errors.cardName 
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-2.5 bg-slate-50 border rounded-lg text-slate-800 font-mono text-sm focus:outline-none focus:ring-2 placeholder:text-slate-400 transition-all ${
                            errors.cardNumber 
                              ? 'border-red-400 focus:ring-red-200 focus:border-red-500' 
                              : 'border-slate-200 focus:ring-indigo-100 focus:border-indigo-500'
                          }`}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-2.5 bg-slate-50 border rounded-lg text-slate-800 text-sm focus:outline-none focus:ring-2 placeholder:text-slate-400 transition-all text-center ${
                            errors.cardExpiry 
                              ? 'border-red-400 focus:ring-red-200 focus:border-red-500' 
                              : 'border-slate-200 focus:ring-indigo-100 focus:border-indigo-500'
                          }`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-2.5 bg-slate-50 border rounded-lg text-slate-800 text-sm focus:outline-none focus:ring-2 placeholder:text-slate-400 transition-all text-center font-mono ${
                            errors.cardCVV 
                              ? 'border-red-400 focus:ring-red-200 focus:border-red-500' 
                              : 'border-slate-200 focus:ring-indigo-100 focus:border-indigo-500'
                          }`}
              ...
              >
                <div className="w-20 h-20 bg-emerald-50 rounded-full flex items-center justify-center text-emerald-500 border border-emerald-100 shadow-md mb-6">
